# tekton-ci-demo
This is a basic Tekton pipelines demo for building an image from github and pushing it to docker hub. Since this is a workshop, theory part of Tekton is not covered here. To learn more about how Tekton works, refer to [this guide](https://tekton.dev/). Throughout this tutorial, k8s is used as an alias for Kubernetes.

## Pre-requisites

* A k8s cluster: Any k8s cluster will do. To get a free cluster on IBM Cloud, [follow this link](https://www.ibm.com/cloud/kubernetes-service). This tutorial will consider an IBM Cloud Kubernetes Service.
